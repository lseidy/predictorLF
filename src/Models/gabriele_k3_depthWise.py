...
class NNModel(nn.Module):
    def __init__(self, name, params):
        ...
        flat_model = type_mode([  # 18, 64²
            ...
            nn.Sequential(
                Conv2d((n_filters*4), (n_filters*8), 3, stride=1, padding=1, groups = (n_filters*4)), nn.PReLU(),  # 10, 8²
                Conv2d((n_filters*8), (n_filters*8), 3, stride=2, padding=1), nn.PReLU(),  # 10, 4²
            ),
            nn.Sequential(
                Conv2d((n_filters*8), 512, 3, stride=1, padding=1, groups = (n_filters*8)), nn.PReLU(),  # 10, 4
            ),
