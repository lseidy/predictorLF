...
class P4D(nn.Module):
    ...
    def __init__(self, params):
        ...
        self.pipeline = nn.Sequential( #16,16,16
            ...
            nn.Conv3d(in_channels=n_filters*4, out_channels=n_filters*16, kernel_size=(3,1, 1), stride=(2,1,1), padding=(1,0,0)), nn.PReLU(),
...
#
        ...
        self.decoder =nn.Sequential( #4,4,4
            ...
            nn.Conv3d(in_channels=n_filters*16, out_channels=n_filters*2, kernel_size=3, stride=1, padding=1), nn.PReLU(),
